...
<body>
    ...
    <div class="container">
        <h1>Manage Cabs</h1>
        <a href="add_cab.php" class="add-cab-btn">Add New Cab</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_cab.php?id=<?php echo $row['id']; ?>">Edit</a> |
                        <a href="delete_cab.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
