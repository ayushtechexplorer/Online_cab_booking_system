...
1. Passenger:  Secure sign-up/login, profile management, ride booking with pickup & drop-off details, view ride history.
2. Driver:  Accept/manage ride requests in real-time, update ride status & schedules, maintain profile/vehicle details, track history.
3. Admin:  Manage drivers, Manage Passenger, monitor rides, oversee operations for efficiency ,Update database.

# Feature 

1. Provide a user-friendly platform for booking, tracking, and managing rides.
2. Allow quick and convenient ride booking with flexible options.
...
<h2>3. Admin panel //Can edit the password too with edit option</h2>
